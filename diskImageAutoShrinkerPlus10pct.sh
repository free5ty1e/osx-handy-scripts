...
echo "New partition end offset $newpartend... removing original ext4 partition table entry...Type i <ENTER> twice again please:"
part1=`parted --script "$loopback" rm 2`
echo "Creating new shrunken ext4 partition table entry...Type i <ENTER> twice again please:"
