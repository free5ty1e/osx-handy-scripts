...
$GMI_SERVER_URL='https://eks-gmiserver-dev.iwsinc.com'
$GMI_USERMANAGER_URL='https://eks-usermanager-dev.iwsinc.com'
$GMI_APP_CODE='ChrisTestAppTenant2fa'
$GMI_TENANT_CODE='ChrisTenant2faTenant'
$GMI_TENANT_OAUTH_CREDENTIALS_BASE64_ENCODED='cm9vdDpYSFQ2ZGRna1NERkREZUlpeA=='
$URLENCODED_USER_ID_TO_2FA='ChrisTestUserTenant2fa%40test.com'
$DEVICE_ID_TO_2FA='1f03ae5acd1c72f6'
